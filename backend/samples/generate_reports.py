...
def generate_pdf_report(
    ...
    subtitle_style = ParagraphStyle(
        "LabSubtitle", parent=styles["Normal"], fontSize=8, leading=11, textColor=colors.HexColor("#475569")
    )
    ...
    cell_style = ParagraphStyle(
        "TableCell", parent=styles["Normal"], fontSize=9, leading=11, textColor=colors.HexColor("#1e293b")
    )
    cell_bold = ParagraphStyle("TableCellBold", parent=cell_style, fontName="Helvetica-Bold")
    cell_abnormal = ParagraphStyle(
        "TableCellAbn", parent=cell_style, fontName="Helvetica-Bold", textColor=colors.HexColor("#b91c1c")
    )
    ...
    header_data = [
        [
            ...
            Paragraph(
                "<b>NABL ACCREDITED LAB</b><br/>ISO 15189:2022 Certified<br/>CIN: U74999MH2015PLC268924", subtitle_style
            ),
        ],
        [
    ...
    demo_data = [
        ...
        [
            ...
            Paragraph("<b>Sample Type:</b> Serum / Whole Blood", cell_style),
        ],
        [
    ...
    footer_data = [
        [
            ...
            Paragraph(
                "<b>Verified By</b><br/>Dr. S. K. Ramanathan, MD (Path)<br/>Reg No: MMC/2004/0981", subtitle_style
            ),
            Paragraph(
                "<b>Chief Pathologist</b><br/>Dr. V. K. Malhotra, MD, FICP<br/>Director, Pathology Services",
                subtitle_style,
            ),
        ]
    ]
    ...
    doc.build(story)
    logger.info("[ReportGen] Generated PDF report: %s", output_path)
